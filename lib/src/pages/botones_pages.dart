    ...
    return Theme(
      ...
      child:BottomNavigationBar(
        ...
        BottomNavigationBarItem(icon:
         ...
         title:Container()),
        BottomNavigationBarItem(icon:
         Icon(Icons.bubble_chart,size: 30.0,
         ),
         title:Container()),
        BottomNavigationBarItem(icon:
  ...
  Widget _botonesRedondeados (){
    return Table(
      children: <TableRow>[
        ...
        TableRow(
          children:[
             _crearBotonRedondeado(Colors.pink,Icons.fastfood,'Food'),
             _crearBotonRedondeado(Colors.red,Icons.g_translate,'Transalte'),
          ]
        ),
        TableRow(
          children:[
             _crearBotonRedondeado(Colors.orange,Icons.add_shopping_cart,'Cart'),
             _crearBotonRedondeado(Colors.teal,Icons.gps_fixed,'GPS'),
          ]
        )
      ],
    );
